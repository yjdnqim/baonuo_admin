...
<head>
    ...
    <style type="text/css">
        ...
        .commitbox_cen div.right span.moveup {
            border: solid 1px #c7c7c7;
            background: #00BFFF;
            border-radius: 3px;
            color: #FFF;
        ...
        .commitbox_cen div.right span.movedown {
            border: solid 1px #c7c7c7;
            background: #00BFFF;
            border-radius: 3px;
            color: #FFF;
    ...
    <script type="text/javascript">
        function moveUp() {
            ...
            var insert = $('input[name="ids"]:checked').closest('tr');
            ...
            <div class="commitbox_top">
                ...
                <table>
                    <tr>
                        ...
                        <td><input name="dname" id="dname" type="text" value="" placeholder="首字母必须为字母或下划线" title="属性名"/>
                        </td>
                        <td style="padding-left: 16px;text-align: right;">属性类型：</td>
                        <td style="padding-bottom: 6px;">
                            <label style="float:left;padding-left: 20px;"><input name="form-field-radiot"
                                                                                 id="form-field-radio1"
                                                                                 onclick="setType('String');"
                                                                                 type="radio" value="icon-edit"
                                                                                 checked="checked"><span class="lbl">String</span></label>
                            <label style="float:left;padding-left: 20px;"><input name="form-field-radiot"
                                                                                 id="form-field-radio2"
                                                                                 onclick="setType('Integer');"
                                                                                 type="radio" value="icon-edit"><span
                                    class="lbl">Integer</span></label>
                            <label style="float:left;padding-left: 20px;"><input name="form-field-radiot"
                                                                                 id="form-field-radio3"
                                                                                 onclick="setType('Date');" type="radio"
                                                                                 value="icon-edit"><span class="lbl">Date</span></label>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding-left: 16px;text-align: right;">其备注：</td>
                        <td><input name="dbz" id="dbz" type="text" value="" placeholder="例如 name的备注为 '姓名'" title="备注"/>
                        </td>
                        <td style="padding-left: 16px;text-align: right;">前台录入：</td>
                        <td style="padding-bottom: 6px;">
                            <label style="float:left;padding-left: 20px;"><input name="form-field-radioq"
                                                                                 id="form-field-radio4"
                                                                                 onclick="isQian('是');" type="radio"
                                                                                 value="icon-edit"
                                                                                 checked="checked"><span
                                    class="lbl">是</span></label>
                            <label style="float:left;padding-left: 20px;"><input name="form-field-radioq"
                                                                                 id="form-field-radio5"
                                                                                 onclick="isQian('否');" type="radio"
                    ...
                    <tr>
                        ...
                        <td><input name="ddefault" id="ddefault" type="text" value="" disabled="disabled"
                                   placeholder="后台附加值时生效" title="默认值"/></td>
                        <td style="padding-left: 16px;text-align: right;"></td>
                        <td>
                            <div class="commitbox_cen">
                                <div class="left" id="cityname"></div>
                                <div class="right">
                                    <span class="save" onClick="saveD()">保存</span>&nbsp;&nbsp;
    ...
    <div id="zhongxin">
        <table style="margin-top: 10px;">
            <tr>
                ...
                <td><input type="text" name="packageName" id="packageName" value="baonuo"
                           placeholder="这里输入包名  (请不要输入特殊字符,请用纯字母)" style="width:370px" title="包名称"/></td>
                <td>&nbsp;&nbsp;例如:com.fh.controller.<font color="red" style="font-weight: bold;">system</font>&nbsp;&nbsp;红色部分
                </td>
            </tr>
            <tr>
                <td style="width:15%;text-align: right;">处理类名：</td>
                <td><input type="text" name="objectName" id="objectName" value="" placeholder="这里输入处理类名称"
                           style="width:370px" title="类名称"/></td>
        ...
        <table id="table_report" class="table table-striped table-bordered table-hover">
            <tr>
                <td style="text-align: center;" colspan="100">
                    ...
                    <a class="btn btn-app btn-success btn-mini" onclick="save();" id="productc"><i
                            class="icon-print"></i>生成</a>
                    <a class="btn btn-app btn-danger btn-mini" onclick="top.Dialog.close();"><i
                            class="icon-share-alt"></i>取消</a>
                </td>
            </tr>
            <tr>
                <td style="text-align: center;" colspan="100">
                    <a class="btn btn-app btn-success btn-mini" onclick="moveUp();">上移</a>
                    <a class="btn btn-app btn-success btn-mini" onclick="moveDown();">下移</a>
                </td>
            </tr>
            <tr>
                <td style="padding-left: 16px;" colspan="100">
...
<script type="text/javascript">
    // $(top.hangge());
	// var EXT_FIELD_1 = 'EXT_FIELD_1,fh,String,fh,扩展字段1,fh,否,fh,无';
	// var EXT_FIELD_2 = 'EXT_FIELD_2,fh,String,fh,扩展字段2,fh,否,fh,无';
	// var EXT_FIELD_3 = 'EXT_FIELD_3,fh,String,fh,扩展字段3,fh,否,fh,无';
	// var CREATE_TIME = 'CREATE_TIME,fh,Date,fh,创建时间,fh,否,fh,无';
	// var EDIT_TIME = 'EDIT_TIME,fh,Date,fh,修改时间,fh,否,fh,无';
	// var OPTION_PERSON = 'OPTION_PERSON,fh,String,fh,操作人,fh,否,fh,无';
    // var IS_DELETED = 'IS_DELETED,fh,Integer,fh,是否已删除,fh,否,fh,0';
	// arrayField(EXT_FIELD_1);
	// arrayField(EXT_FIELD_2);
	// arrayField(EXT_FIELD_3);
	// arrayField(CREATE_TIME);
	// arrayField(EDIT_TIME);
	// arrayField(OPTION_PERSON);
    // arrayField(IS_DELETED);
